<?php
/**
 * File for class PaymentWebStructBasePaymentDataVO
 * @package PaymentWeb
 * @subpackage Structs
 ...
 */
/**
 * This class stands for PaymentWebStructBasePaymentDataVO originally named basePaymentDataVO
 ...
 * @date 2014-12-22
 */
abstract class PaymentWebStructBasePaymentDataVO extends PaymentWebStructEntityVO
{
    /**
     * The date
     * Meta informations extracted from the WSDL
     ...
     * Meta informations extracted from the WSDL
     * - minOccurs : 0
     * @var PaymentWebEnumPaymentStatusVO
     */
    public $status;
    /**
     ...
     * @param PaymentWebEnumPaymentStatusVO $_status
     * @return PaymentWebStructBasePaymentDataVO
     */
    ...
    {
        PaymentWebWsdlClass::__construct(array('date'=>$_date,'formattedDate'=>$_formattedDate,'processDate'=>$_processDate,'formattedProcessDate'=>$_formattedProcessDate,'amount'=>$_amount,'formattedAmount'=>$_formattedAmount,'status'=>$_status),false);
    }
    /**
     * Get date value
    ...
    /**
     * Get status value
     * @return PaymentWebEnumPaymentStatusVO|null
     */
    ...
    /**
     * Set status value
     * @uses PaymentWebEnumPaymentStatusVO::valueIsValid()
     * @param PaymentWebEnumPaymentStatusVO $_status the status
     * @return PaymentWebEnumPaymentStatusVO
     */
    public function setStatus($_status)
    {
        if(!PaymentWebEnumPaymentStatusVO::valueIsValid($_status))
        {
            return false;
        }
