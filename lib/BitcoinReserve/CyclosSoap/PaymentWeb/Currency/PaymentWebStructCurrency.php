<?php
/**
 * File for class PaymentWebStructCurrency
 * @package PaymentWeb
 * @subpackage Structs
 ...
 */
/**
 * This class stands for PaymentWebStructCurrency originally named currency
 ...
 * @date 2014-12-22
 */
class PaymentWebStructCurrency extends PaymentWebStructEntityVO
{
    /**
     * The symbol
     * Meta informations extracted from the WSDL
    ...
    {
        PaymentWebWsdlClass::__construct(array('symbol'=>$_symbol,'name'=>$_name,'pattern'=>$_pattern),false);
    }
    /**
     * Get symbol value
     * @return string|null
