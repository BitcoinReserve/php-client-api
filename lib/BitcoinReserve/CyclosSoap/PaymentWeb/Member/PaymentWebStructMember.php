<?php
/**
 * File for class PaymentWebStructMember
 * @package PaymentWeb
 * @subpackage Structs
 ...
 */
/**
 * This class stands for PaymentWebStructMember originally named member
 ...
 * @date 2014-12-22
 */
class PaymentWebStructMember extends PaymentWebStructEntityVO
{
    /**
     * The name
     * Meta informations extracted from the WSDL
    ...
    {
        PaymentWebWsdlClass::__construct(array('name'=>$_name,'accountNumber'=>$_accountNumber,'groupId'=>$_groupId),false);
    }
    /**
     * Get name value
     * @return string|null
