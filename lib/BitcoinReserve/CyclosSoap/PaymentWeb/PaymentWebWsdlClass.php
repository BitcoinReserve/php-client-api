<?php
/**
 * File for PaymentWebWsdlClass to communicate with SOAP service
 * @package PaymentWeb
 ...
 */
/**
 * PaymentWebWsdlClass to communicate with SOAP service
 * 
 * @package PaymentWeb
 * @author WsdlToPhp Team <contact@wsdltophp.com>
 * @version 20140325-01
 * @date 2014-12-22
 */
class PaymentWebWsdlClass extends stdClass implements ArrayAccess,Iterator,Countable
{
    /**
     ...
     * @var string
     */
    const VALUE_WSDL_URL = 'https://testnet.bitcoinreserve.ch/services/payment?wsdl';
    /**
    ...
    /**
     * Constructor
     * @uses PaymentWebWsdlClass::setLastError()
     * @uses PaymentWebWsdlClass::initSoapClient()
     * @uses PaymentWebWsdlClass::initInternArrayToIterate()
     * @uses PaymentWebWsdlClass::_set()
     ...
     * @return PaymentWebWsdlClass|null
     */
    public static function __set_state(array $_array,$_className = __CLASS__)
    {
        if(class_exists($_className))
        {
            ...
            if(is_object($object) && is_subclass_of($object,'PaymentWebWsdlClass'))
            {
     ...
     * @uses PaymentWebClassMap::classMap()
     * @uses PaymentWebWsdlClass::getDefaultWsdlOptions()
     * @uses PaymentWebWsdlClass::getSoapClientClassName()
     * @uses PaymentWebWsdlClass::setSoapClient()
     * @param array $_wsdlOptions WSDL options
     * @return void
     */
    public function initSoapClient($_wsdlOptions)
    {
        if(class_exists('PaymentWebClassMap',true))
        {
            $wsdlOptions = array();
            $wsdlOptions['classmap'] = PaymentWebClassMap::classMap();
     ...
     * If a class is named as {PaymentWeb}SoapClient, then this is the class that will be used.
    ...
    {
        if(class_exists('PaymentWebSoapClient') && is_subclass_of('PaymentWebSoapClient','SoapClient'))
            return 'PaymentWebSoapClient';
        else
            return 'SoapClient';
    }
    /**
     * Method returning all default options values
     * @uses PaymentWebWsdlClass::WSDL_CACHE_WSDL
     * @uses PaymentWebWsdlClass::WSDL_COMPRESSION
     * @uses PaymentWebWsdlClass::WSDL_CONNECTION_TIMEOUT
     * @uses PaymentWebWsdlClass::WSDL_ENCODING
     * @uses PaymentWebWsdlClass::WSDL_EXCEPTIONS
     * @uses PaymentWebWsdlClass::WSDL_FEATURES
     * @uses PaymentWebWsdlClass::WSDL_LOGIN
     * @uses PaymentWebWsdlClass::WSDL_PASSWORD
     * @uses PaymentWebWsdlClass::WSDL_SOAP_VERSION
     * @uses PaymentWebWsdlClass::WSDL_STREAM_CONTEXT
     * @uses PaymentWebWsdlClass::WSDL_TRACE
     * @uses PaymentWebWsdlClass::WSDL_TYPEMAP
     * @uses PaymentWebWsdlClass::WSDL_URL
     * @uses PaymentWebWsdlClass::VALUE_WSDL_URL
     * @uses PaymentWebWsdlClass::WSDL_USER_AGENT
     * @uses PaymentWebWsdlClass::WSDL_PROXY_HOST
     * @uses PaymentWebWsdlClass::WSDL_PROXY_PORT
     * @uses PaymentWebWsdlClass::WSDL_PROXY_LOGIN
     * @uses PaymentWebWsdlClass::WSDL_PROXY_PASSWORD
     * @uses PaymentWebWsdlClass::WSDL_LOCAL_CERT
     * @uses PaymentWebWsdlClass::WSDL_PASSPHRASE
     * @uses PaymentWebWsdlClass::WSDL_AUTHENTICATION
     * @uses PaymentWebWsdlClass::WSDL_SSL_METHOD
     ...
     * @uses PaymentWebWsdlClass::getSoapClient()
     * @uses PaymentWebWsdlClass::getFormatedXml()
     ...
     * @uses PaymentWebWsdlClass::getSoapClient()
     * @uses PaymentWebWsdlClass::convertStringHeadersToArray()
     ...
     * @uses PaymentWebWsdlClass::count()
     * @return int
     */
     ...
     * @uses PaymentWebWsdlClass::getInternArrayToIterate()
     * @uses PaymentWebWsdlClass::getInternArrayToIterateIsArray()
     * @return int
     */
     ...
     * @uses PaymentWebWsdlClass::offsetGet()
     * @return mixed
     */
     ...
     * @uses PaymentWebWsdlClass::getInternArrayToIterateOffset()
     * @uses PaymentWebWsdlClass::setInternArrayToIterateOffset()
     * @return int
     */
     ...
     * @uses PaymentWebWsdlClass::getInternArrayToIterateOffset()
     * @uses PaymentWebWsdlClass::offsetExists()
     * @return bool true|false
     */
     ...
     * @see PaymentWebWsdlClass::offsetGet()
     * @uses PaymentWebWsdlClass::offsetGet()
     * @param int $_index
     * @return mixed
     */
     ...
     * @uses PaymentWebWsdlClass::getAttributeName()
     * @uses PaymentWebWsdlClass::__toString()
     * @uses PaymentWebWsdlClass::_set()
     * @uses PaymentWebWsdlClass::_get()
     * @uses PaymentWebWsdlClass::setInternArrayToIterate()
     * @uses PaymentWebWsdlClass::setInternArrayToIterateIsArray()
     * @uses PaymentWebWsdlClass::setInternArrayToIterateOffset()
     ...
     * @uses PaymentWebWsdlClass::item()
     * @uses PaymentWebWsdlClass::length()
     * @return mixed
     */
