<?php
/**
 * File for class WebShopWebStructMember
 * @package WebShopWeb
 * @subpackage Structs
 ...
 */
/**
 * This class stands for WebShopWebStructMember originally named member
 ...
 * @date 2014-12-22
 */
class WebShopWebStructMember extends WebShopWebStructEntityVO
{
    /**
     * The name
     * Meta informations extracted from the WSDL
    ...
    {
        WebShopWebWsdlClass::__construct(array('name'=>$_name,'accountNumber'=>$_accountNumber,'groupId'=>$_groupId),false);
    }
    /**
     * Get name value
     * @return string|null
