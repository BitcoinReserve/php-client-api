<?php
/**
 * File for WebShopWebWsdlClass to communicate with SOAP service
 * @package WebShopWeb
 ...
 */
/**
 * WebShopWebWsdlClass to communicate with SOAP service
 * 
 * @package WebShopWeb
 * @author WsdlToPhp Team <contact@wsdltophp.com>
 * @version 20140325-01
 * @date 2014-12-22
 */
class WebShopWebWsdlClass extends stdClass implements ArrayAccess,Iterator,Countable
{
    /**
     ...
     * @var string
     */
    const VALUE_WSDL_URL = 'https://testnet.bitcoinreserve.ch/services/webshop?wsdl';
    /**
    ...
    /**
     * Constructor
     * @uses WebShopWebWsdlClass::setLastError()
     * @uses WebShopWebWsdlClass::initSoapClient()
     * @uses WebShopWebWsdlClass::initInternArrayToIterate()
     * @uses WebShopWebWsdlClass::_set()
     ...
     * @return WebShopWebWsdlClass|null
     */
    public static function __set_state(array $_array,$_className = __CLASS__)
    {
        if(class_exists($_className))
        {
            ...
            if(is_object($object) && is_subclass_of($object,'WebShopWebWsdlClass'))
            {
     ...
     * @uses WebShopWebClassMap::classMap()
     * @uses WebShopWebWsdlClass::getDefaultWsdlOptions()
     * @uses WebShopWebWsdlClass::getSoapClientClassName()
     * @uses WebShopWebWsdlClass::setSoapClient()
     * @param array $_wsdlOptions WSDL options
     * @return void
     */
    public function initSoapClient($_wsdlOptions)
    {
        if(class_exists('WebShopWebClassMap',true))
        {
            $wsdlOptions = array();
            $wsdlOptions['classmap'] = WebShopWebClassMap::classMap();
     ...
     * If a class is named as {WebShopWeb}SoapClient, then this is the class that will be used.
    ...
    {
        if(class_exists('WebShopWebSoapClient') && is_subclass_of('WebShopWebSoapClient','SoapClient'))
            return 'WebShopWebSoapClient';
        else
            return 'SoapClient';
    }
    /**
     * Method returning all default options values
     * @uses WebShopWebWsdlClass::WSDL_CACHE_WSDL
     * @uses WebShopWebWsdlClass::WSDL_COMPRESSION
     * @uses WebShopWebWsdlClass::WSDL_CONNECTION_TIMEOUT
     * @uses WebShopWebWsdlClass::WSDL_ENCODING
     * @uses WebShopWebWsdlClass::WSDL_EXCEPTIONS
     * @uses WebShopWebWsdlClass::WSDL_FEATURES
     * @uses WebShopWebWsdlClass::WSDL_LOGIN
     * @uses WebShopWebWsdlClass::WSDL_PASSWORD
     * @uses WebShopWebWsdlClass::WSDL_SOAP_VERSION
     * @uses WebShopWebWsdlClass::WSDL_STREAM_CONTEXT
     * @uses WebShopWebWsdlClass::WSDL_TRACE
     * @uses WebShopWebWsdlClass::WSDL_TYPEMAP
     * @uses WebShopWebWsdlClass::WSDL_URL
     * @uses WebShopWebWsdlClass::VALUE_WSDL_URL
     * @uses WebShopWebWsdlClass::WSDL_USER_AGENT
     * @uses WebShopWebWsdlClass::WSDL_PROXY_HOST
     * @uses WebShopWebWsdlClass::WSDL_PROXY_PORT
     * @uses WebShopWebWsdlClass::WSDL_PROXY_LOGIN
     * @uses WebShopWebWsdlClass::WSDL_PROXY_PASSWORD
     * @uses WebShopWebWsdlClass::WSDL_LOCAL_CERT
     * @uses WebShopWebWsdlClass::WSDL_PASSPHRASE
     * @uses WebShopWebWsdlClass::WSDL_AUTHENTICATION
     * @uses WebShopWebWsdlClass::WSDL_SSL_METHOD
     ...
     * @uses WebShopWebWsdlClass::getSoapClient()
     * @uses WebShopWebWsdlClass::getFormatedXml()
     ...
     * @uses WebShopWebWsdlClass::getSoapClient()
     * @uses WebShopWebWsdlClass::convertStringHeadersToArray()
     ...
     * @uses WebShopWebWsdlClass::count()
     * @return int
     */
     ...
     * @uses WebShopWebWsdlClass::getInternArrayToIterate()
     * @uses WebShopWebWsdlClass::getInternArrayToIterateIsArray()
     * @return int
     */
     ...
     * @uses WebShopWebWsdlClass::offsetGet()
     * @return mixed
     */
     ...
     * @uses WebShopWebWsdlClass::getInternArrayToIterateOffset()
     * @uses WebShopWebWsdlClass::setInternArrayToIterateOffset()
     * @return int
     */
     ...
     * @uses WebShopWebWsdlClass::getInternArrayToIterateOffset()
     * @uses WebShopWebWsdlClass::offsetExists()
     * @return bool true|false
     */
     ...
     * @see WebShopWebWsdlClass::offsetGet()
     * @uses WebShopWebWsdlClass::offsetGet()
     * @param int $_index
     * @return mixed
     */
     ...
     * @uses WebShopWebWsdlClass::getAttributeName()
     * @uses WebShopWebWsdlClass::__toString()
     * @uses WebShopWebWsdlClass::_set()
     * @uses WebShopWebWsdlClass::_get()
     * @uses WebShopWebWsdlClass::setInternArrayToIterate()
     * @uses WebShopWebWsdlClass::setInternArrayToIterateIsArray()
     * @uses WebShopWebWsdlClass::setInternArrayToIterateOffset()
     ...
     * @uses WebShopWebWsdlClass::item()
     * @uses WebShopWebWsdlClass::length()
     * @return mixed
     */
