<?php
/**
 * File for AccountWebWsdlClass to communicate with SOAP service
 * @package AccountWeb
 ...
 */
/**
 * AccountWebWsdlClass to communicate with SOAP service
 * 
 * @package AccountWeb
 * @author WsdlToPhp Team <contact@wsdltophp.com>
 * @version 20140325-01
 * @date 2014-12-23
 */
class AccountWebWsdlClass extends stdClass implements ArrayAccess,Iterator,Countable
{
    /**
     ...
     * @var string
     */
    const VALUE_WSDL_URL = 'https://testnet.bitcoinreserve.ch/services/account?wsdl';
    /**
    ...
    /**
     * Constructor
     * @uses AccountWebWsdlClass::setLastError()
     * @uses AccountWebWsdlClass::initSoapClient()
     * @uses AccountWebWsdlClass::initInternArrayToIterate()
     * @uses AccountWebWsdlClass::_set()
     ...
     * @return AccountWebWsdlClass|null
     */
    public static function __set_state(array $_array,$_className = __CLASS__)
    {
        if(class_exists($_className))
        {
            ...
            if(is_object($object) && is_subclass_of($object,'AccountWebWsdlClass'))
            {
     ...
     * @uses AccountWebClassMap::classMap()
     * @uses AccountWebWsdlClass::getDefaultWsdlOptions()
     * @uses AccountWebWsdlClass::getSoapClientClassName()
     * @uses AccountWebWsdlClass::setSoapClient()
     * @param array $_wsdlOptions WSDL options
     * @return void
     */
    public function initSoapClient($_wsdlOptions)
    {
        if(class_exists('AccountWebClassMap',true))
        {
            $wsdlOptions = array();
            $wsdlOptions['classmap'] = AccountWebClassMap::classMap();
     ...
     * If a class is named as {AccountWeb}SoapClient, then this is the class that will be used.
    ...
    {
        if(class_exists('AccountWebSoapClient') && is_subclass_of('AccountWebSoapClient','SoapClient'))
            return 'AccountWebSoapClient';
        else
            return 'SoapClient';
    }
    /**
     * Method returning all default options values
     * @uses AccountWebWsdlClass::WSDL_CACHE_WSDL
     * @uses AccountWebWsdlClass::WSDL_COMPRESSION
     * @uses AccountWebWsdlClass::WSDL_CONNECTION_TIMEOUT
     * @uses AccountWebWsdlClass::WSDL_ENCODING
     * @uses AccountWebWsdlClass::WSDL_EXCEPTIONS
     * @uses AccountWebWsdlClass::WSDL_FEATURES
     * @uses AccountWebWsdlClass::WSDL_LOGIN
     * @uses AccountWebWsdlClass::WSDL_PASSWORD
     * @uses AccountWebWsdlClass::WSDL_SOAP_VERSION
     * @uses AccountWebWsdlClass::WSDL_STREAM_CONTEXT
     * @uses AccountWebWsdlClass::WSDL_TRACE
     * @uses AccountWebWsdlClass::WSDL_TYPEMAP
     * @uses AccountWebWsdlClass::WSDL_URL
     * @uses AccountWebWsdlClass::VALUE_WSDL_URL
     * @uses AccountWebWsdlClass::WSDL_USER_AGENT
     * @uses AccountWebWsdlClass::WSDL_PROXY_HOST
     * @uses AccountWebWsdlClass::WSDL_PROXY_PORT
     * @uses AccountWebWsdlClass::WSDL_PROXY_LOGIN
     * @uses AccountWebWsdlClass::WSDL_PROXY_PASSWORD
     * @uses AccountWebWsdlClass::WSDL_LOCAL_CERT
     * @uses AccountWebWsdlClass::WSDL_PASSPHRASE
     * @uses AccountWebWsdlClass::WSDL_AUTHENTICATION
     * @uses AccountWebWsdlClass::WSDL_SSL_METHOD
     ...
     * @uses AccountWebWsdlClass::getSoapClient()
     * @uses AccountWebWsdlClass::getFormatedXml()
     ...
     * @uses AccountWebWsdlClass::getSoapClient()
     * @uses AccountWebWsdlClass::convertStringHeadersToArray()
     ...
     * @uses AccountWebWsdlClass::count()
     * @return int
     */
     ...
     * @uses AccountWebWsdlClass::getInternArrayToIterate()
     * @uses AccountWebWsdlClass::getInternArrayToIterateIsArray()
     * @return int
     */
     ...
     * @uses AccountWebWsdlClass::offsetGet()
     * @return mixed
     */
     ...
     * @uses AccountWebWsdlClass::getInternArrayToIterateOffset()
     * @uses AccountWebWsdlClass::setInternArrayToIterateOffset()
     * @return int
     */
     ...
     * @uses AccountWebWsdlClass::getInternArrayToIterateOffset()
     * @uses AccountWebWsdlClass::offsetExists()
     * @return bool true|false
     */
     ...
     * @see AccountWebWsdlClass::offsetGet()
     * @uses AccountWebWsdlClass::offsetGet()
     * @param int $_index
     * @return mixed
     */
     ...
     * @uses AccountWebWsdlClass::getAttributeName()
     * @uses AccountWebWsdlClass::__toString()
     * @uses AccountWebWsdlClass::_set()
     * @uses AccountWebWsdlClass::_get()
     * @uses AccountWebWsdlClass::setInternArrayToIterate()
     * @uses AccountWebWsdlClass::setInternArrayToIterateIsArray()
     * @uses AccountWebWsdlClass::setInternArrayToIterateOffset()
     ...
     * @uses AccountWebWsdlClass::item()
     * @uses AccountWebWsdlClass::length()
     * @return mixed
     */
