<?php
/**
 * File for class AccountWebStructAccountStatus
 * @package AccountWeb
 * @subpackage Structs
 ...
 */
/**
 * This class stands for AccountWebStructAccountStatus originally named accountStatus
 ...
 * @date 2014-12-23
 */
class AccountWebStructAccountStatus extends AccountWebWsdlClass
{
    /**
     * The balance
     * Meta informations extracted from the WSDL
