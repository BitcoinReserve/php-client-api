<?php
/**
 * File for class MemberWebStructLoadByAccountNumberResponse
 * @package MemberWeb
 * @subpackage Structs
 ...
 */
/**
 * This class stands for MemberWebStructLoadByAccountNumberResponse originally named loadByAccountNumberResponse
 ...
 * @date 2014-12-22
 */
class MemberWebStructLoadByAccountNumberResponse extends MemberWebWsdlClass
{
    /**
     * The return
     * Meta informations extracted from the WSDL
    ...
    public $return;
    /**
     * Constructor method for loadByAccountNumberResponse
