<?php
/**
 * File for MemberWebWsdlClass to communicate with SOAP service
 * @package MemberWeb
 ...
 */
/**
 * MemberWebWsdlClass to communicate with SOAP service
 * 
 * @package MemberWeb
 * @author WsdlToPhp Team <contact@wsdltophp.com>
 * @version 20140325-01
 * @date 2014-12-22
 */
class MemberWebWsdlClass extends stdClass implements ArrayAccess,Iterator,Countable
{
    /**
     ...
     * @var string
     */
    const VALUE_WSDL_URL = 'https://testnet.bitcoinreserve.ch/services/members?wsdl';
    /**
    ...
    /**
     * Constructor
     * @uses MemberWebWsdlClass::setLastError()
     * @uses MemberWebWsdlClass::initSoapClient()
     * @uses MemberWebWsdlClass::initInternArrayToIterate()
     * @uses MemberWebWsdlClass::_set()
     ...
     * @return MemberWebWsdlClass|null
     */
    public static function __set_state(array $_array,$_className = __CLASS__)
    {
        if(class_exists($_className))
        {
            ...
            if(is_object($object) && is_subclass_of($object,'MemberWebWsdlClass'))
            {
     ...
     * @uses MemberWebClassMap::classMap()
     * @uses MemberWebWsdlClass::getDefaultWsdlOptions()
     * @uses MemberWebWsdlClass::getSoapClientClassName()
     * @uses MemberWebWsdlClass::setSoapClient()
     * @param array $_wsdlOptions WSDL options
     * @return void
     */
    public function initSoapClient($_wsdlOptions)
    {
        if(class_exists('MemberWebClassMap',true))
        {
            $wsdlOptions = array();
            $wsdlOptions['classmap'] = MemberWebClassMap::classMap();
     ...
     * If a class is named as {MemberWeb}SoapClient, then this is the class that will be used.
    ...
    {
        if(class_exists('MemberWebSoapClient') && is_subclass_of('MemberWebSoapClient','SoapClient'))
            return 'MemberWebSoapClient';
        else
            return 'SoapClient';
    }
    /**
     * Method returning all default options values
     * @uses MemberWebWsdlClass::WSDL_CACHE_WSDL
     * @uses MemberWebWsdlClass::WSDL_COMPRESSION
     * @uses MemberWebWsdlClass::WSDL_CONNECTION_TIMEOUT
     * @uses MemberWebWsdlClass::WSDL_ENCODING
     * @uses MemberWebWsdlClass::WSDL_EXCEPTIONS
     * @uses MemberWebWsdlClass::WSDL_FEATURES
     * @uses MemberWebWsdlClass::WSDL_LOGIN
     * @uses MemberWebWsdlClass::WSDL_PASSWORD
     * @uses MemberWebWsdlClass::WSDL_SOAP_VERSION
     * @uses MemberWebWsdlClass::WSDL_STREAM_CONTEXT
     * @uses MemberWebWsdlClass::WSDL_TRACE
     * @uses MemberWebWsdlClass::WSDL_TYPEMAP
     * @uses MemberWebWsdlClass::WSDL_URL
     * @uses MemberWebWsdlClass::VALUE_WSDL_URL
     * @uses MemberWebWsdlClass::WSDL_USER_AGENT
     * @uses MemberWebWsdlClass::WSDL_PROXY_HOST
     * @uses MemberWebWsdlClass::WSDL_PROXY_PORT
     * @uses MemberWebWsdlClass::WSDL_PROXY_LOGIN
     * @uses MemberWebWsdlClass::WSDL_PROXY_PASSWORD
     * @uses MemberWebWsdlClass::WSDL_LOCAL_CERT
     * @uses MemberWebWsdlClass::WSDL_PASSPHRASE
     * @uses MemberWebWsdlClass::WSDL_AUTHENTICATION
     * @uses MemberWebWsdlClass::WSDL_SSL_METHOD
     ...
     * @uses MemberWebWsdlClass::getSoapClient()
     * @uses MemberWebWsdlClass::getFormatedXml()
     ...
     * @uses MemberWebWsdlClass::getSoapClient()
     * @uses MemberWebWsdlClass::convertStringHeadersToArray()
     ...
     * @uses MemberWebWsdlClass::getInternArrayToIterate()
     * @uses MemberWebWsdlClass::getInternArrayToIterateIsArray()
     * @return int
     */
     ...
     * @uses MemberWebWsdlClass::offsetGet()
     * @return mixed
     */
     ...
     * @uses MemberWebWsdlClass::getInternArrayToIterateOffset()
     * @uses MemberWebWsdlClass::setInternArrayToIterateOffset()
     * @return int
     */
     ...
     * @uses MemberWebWsdlClass::getInternArrayToIterateOffset()
     * @uses MemberWebWsdlClass::offsetExists()
     * @return bool true|false
     */
     ...
     * @see MemberWebWsdlClass::offsetGet()
     * @uses MemberWebWsdlClass::offsetGet()
     * @param int $_index
     * @return mixed
     */
     ...
     * @uses MemberWebWsdlClass::getAttributeName()
     * @uses MemberWebWsdlClass::__toString()
     * @uses MemberWebWsdlClass::_set()
     * @uses MemberWebWsdlClass::_get()
     * @uses MemberWebWsdlClass::setInternArrayToIterate()
     * @uses MemberWebWsdlClass::setInternArrayToIterateIsArray()
     * @uses MemberWebWsdlClass::setInternArrayToIterateOffset()
     ...
     * @uses MemberWebWsdlClass::item()
     * @uses MemberWebWsdlClass::length()
     * @return mixed
     */
